...
spring_pos1 = ( boggie_x - 0.01, r_actuator_pos2[1], r_actuator_pos2[2] )
spring_pos2 = ( boggie_x - 0.01, r_actuator_pos2[1] - 0.06, chassis_height - 0.02 )
spring_width = 0.01
spring_gap = 0.007
spring_color = alu
...
wheels[0].name = 'wheel 1'
wheels[1].name = 'wheel 2'
wheels[2].name = 'wheel 3'
wheels[3].name = 'wheel 4'
...
front_frame.append( rod( ( wheelbase/2, track/2, wheels_radius ), ( wheelbase/2, wheels_axle_y, wheels_radius ), mat=front_frame_color ) )
front_frame.append( rod( ( wheelbase/2, -track/2, wheels_radius ), ( wheelbase/2, -wheels_axle_y, wheels_radius ), mat=front_frame_color ) )
front_frame.append( sphere( ( wheelbase/2, wheels_axle_y, wheels_radius ), mat=front_frame_color ) )
front_frame.append( sphere( ( wheelbase/2, -wheels_axle_y, wheels_radius ), mat=front_frame_color ) )
front_frame.append( rod( ( wheelbase/2, wheels_axle_y, wheels_radius ), ( wheelbase/2, 0, chassis_height ), ( 0, 0, 0 ), ( 0, track/2.5, 0 ), mat=front_frame_color ) )
front_frame.append( rod( ( wheelbase/2, -wheels_axle_y, wheels_radius ), ( wheelbase/2, 0, chassis_height ), ( 0, 0, 0 ), ( 0, -track/2.5, 0 ), mat=front_frame_color ) )
...
boggie.append( rod( ( -wheelbase/2, track/2, wheels_radius ), ( -wheelbase/2, wheels_axle_y, wheels_radius ), mat=boggie_color ) )
boggie.append( rod( ( -wheelbase/2, -track/2, wheels_radius ), ( -wheelbase/2, -wheels_axle_y, wheels_radius ), mat=boggie_color ) )
boggie.append( sphere( ( -wheelbase/2, wheels_axle_y, wheels_radius ), mat=boggie_color ) )
boggie.append( sphere( ( -wheelbase/2, -wheels_axle_y, wheels_radius ), mat=boggie_color ) )
boggie.append( rod( ( -wheelbase/2, wheels_axle_y, wheels_radius ), ( boggie_x, 0, chassis_height ), ( 0.1, 0, 0 ), ( 0, track/3, 0 ), mat=boggie_color ) )
boggie.append( rod( ( -wheelbase/2, -wheels_axle_y, wheels_radius ), ( boggie_x, 0, chassis_height ), ( 0.1, 0, 0 ), ( 0, -track/3, 0 ), mat=boggie_color ) )
...
add_hinge_joint( wheels[0], front_frame_BM, ( wheelbase/2, track/2, wheels_radius ), ( 0, 1, 0 ), name='wheel 1' )
add_hinge_joint( wheels[1], front_frame_BM, ( wheelbase/2, -track/2, wheels_radius ), ( 0, 1, 0 ), name='wheel 2' )
add_hinge_joint( wheels[2], boggie_BM, ( -wheelbase/2, track/2, wheels_radius ), ( 0, 1, 0 ), name='wheel 3' )
add_hinge_joint( wheels[3], boggie_BM, ( -wheelbase/2, -track/2, wheels_radius ), ( 0, 1, 0 ), name='wheel 4' )
