...
class Roverctrl( morse.core.actuator.Actuator ) :
	...
	def __init__( self, obj, parent=None ):
		...
		self.wheel_1 = self.scene.objects['wheel 1']
		self.wheel_2 = self.scene.objects['wheel 2']
		...
		self.wheels_controllers.append( hingeController( self.wheel_1, self.front_frame, ( 0, 1, 0 ), 'SPEED', self.wheels_Kp, self.wheels_Ki, self.wheels_Kd, self.wheels_max_torque ) )
		self.wheels_controllers.append( hingeController( self.wheel_2, self.front_frame, ( 0, 1, 0 ), 'SPEED', self.wheels_Kp, self.wheels_Ki, self.wheels_Kd, self.wheels_max_torque ) )
		self.wheels_controllers.append( hingeController( self.wheel_3, self.boggie, ( 0, 1, 0 ), 'SPEED', self.wheels_Kp, self.wheels_Ki, self.wheels_Kd, self.wheels_max_torque ) )
		self.wheels_controllers.append( hingeController( self.wheel_4, self.boggie, ( 0, 1, 0 ), 'SPEED', self.wheels_Kp, self.wheels_Ki, self.wheels_Kd, self.wheels_max_torque ) )
